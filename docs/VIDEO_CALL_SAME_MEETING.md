...
For the doctor (web) and patient (app) to see each other in a call, **both must join the same Cloudflare Realtime meeting**.
...
- **App**: Check device logs for `[VideoCall] Token meeting ID: <id>`.
